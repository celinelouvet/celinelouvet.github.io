...
export const content = (
  ...
  >
    <HStack width="100%" height="100%" gap="brand.300">
      ...
      <Stack flex="1" height="100%" alignItems="flex-start" gap="brand.100">
        <chakra.strong>Plusieurs choix possibles</chakra.strong>
        <ProgressiveList
          marginBottom="0"
          items={[
            { text: 'Datastore', shown: false },
            { text: 'Firestore', shown: false },
            { text: 'Spanner', shown: false },
            { text: 'Cloud SQL', shown: false },
