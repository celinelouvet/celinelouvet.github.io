...
const examples = [
  ...
  { text: 'Droits : appel d’un service', shown: false },
];
...
export const note = (
  <SlideNote>
    <Text>
      Quand on fait de la délégation d’identité, avec un `su` ou `sudo`. On va
      pouvoir prendre l’identité d’un autre utilisateur.
    </Text>
  </SlideNote>
);
