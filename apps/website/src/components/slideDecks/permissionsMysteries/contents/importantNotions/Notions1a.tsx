...
const items = [
  ...
  { text: 'Départ d’un employé', shown: true },
  { text: 'Fuite d’un identifiant', shown: true },
];
...
export const content = (
  ...
  >
    <HStack width="100%" height="100%" gap="brand.500" opacity={0}>
...
export const note = (
  <SlideNote>
    <Text>La première notion est la révocation.</Text>
  </SlideNote>
);
