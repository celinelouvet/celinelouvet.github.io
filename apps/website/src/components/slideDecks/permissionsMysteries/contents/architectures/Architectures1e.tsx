...
export const note = (
  <SlideNote>
    <Text>
      Ca sera l’occasion d’utiliser le pattern du monolithe modulaire pour
      préparer un futur découpage en microservices.
    </Text>
    <Text>
      Thomas Pierrain a écrit un article sur le sujet qui explique en détail ce
      pattern et je crois qu’il a fait un talk à Devoxx dessus.
    </Text>
  </SlideNote>
);
