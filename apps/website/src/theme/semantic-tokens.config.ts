...
const strikeBrandGradiant = `to right bottom, transparent 47%, rgba(${brand900_rgb}, 1) 47%, rgba(${brand900_rgb}, 1) 49%, rgba(${brand500_rgb}, 1) 49%, rgba(${brand500_rgb}, 1) 51%, rgba(${brand900_rgb}, 1) 51%, rgba(${brand900_rgb}, 1) 53%, transparent 52%`;
const strikeOrangeGradiant = `to right bottom, transparent 47%, rgba(${brand900_rgb}, 1) 47%, rgba(${brand900_rgb}, 1) 49%, rgba(${brandOrange_rgb}, 1) 49%, rgba(${brandOrange_rgb}, 1) 51%, rgba(${brand900_rgb}, 1) 51%, rgba(${brand900_rgb}, 1) 53%, transparent 52%`;

export const semanticTokens = {
  gradients: {
    brand: { value: `linear-gradient(${brandGradient})` },
    strike: { value: `linear-gradient(${strikeBrandGradiant})` },
    'strike-orange': { value: `linear-gradient(${strikeOrangeGradiant})` },
  },
  sizes: {
